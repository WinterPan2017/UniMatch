...
from util.mask import RandomMaskGenerator
...
def main():
    ...
    for epoch in range(epoch + 1, cfg['epochs']):
        ...
        mask_gen = RandomMaskGenerator(cfg['mask_ratio'], cfg['patch_size'])
        ...
        for i, ((img_x, mask_x),
            ...
            num_unlabeled, c, h, w = img_u_w.shape
            mic_source = img_u_w 
            img_masked = mask_gen(mic_source)
